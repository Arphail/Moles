...
namespace InteractiveObj.Treasure
{
    public class TreasureSpawner : MonoBehaviour
    {
        ...
        [SerializeField] private Goldmine.Goldmine[] _goldmines;
        [SerializeField] private Treasure _treasureTemplate;
        [SerializeField] private Radar.Radar _radar;
        ...
        private void OnGoldmineActivated(Goldmine.Goldmine goldmine)
        {
            _activatedGoldmines++;
            goldmine.Activated -= OnGoldmineActivated;
        }
